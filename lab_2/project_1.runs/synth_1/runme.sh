...
HD_PWD='C:/Users/da133662/fpga_design_5722/lab_2/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_color_changer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_color_changer.tcl
