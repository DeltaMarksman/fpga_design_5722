...
HD_PWD='C:/Users/da133662/fpga_design_5722/lab_2/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_color_changer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_color_changer.tcl -notrace
